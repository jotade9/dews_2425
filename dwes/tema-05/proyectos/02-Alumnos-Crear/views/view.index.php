    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table">
                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <a href="eliminar.php?indice=<?= $alumno->id ?>" title="Eliminar" class="btn btn-danger" onclick="return confirm('Confimar elimación del artículo')"><i class="bi bi-trash-fill"></i></a>
                ...
                <tfoot>
                    <tr>
                        <td colspan="10">Nº Registros <?= $alumnos->num_rows ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
