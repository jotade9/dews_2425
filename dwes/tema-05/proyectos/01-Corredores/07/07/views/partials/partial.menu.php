...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php">Corredor</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="ordenar.php?criterio=5">Sexo</a></li>
                        <li><a class="dropdown-item" href="ordenar.php?criterio=6">Edad</a></li>
                        <li><a class="dropdown-item" href="ordenar.php?criterio=7">Categoria</a></li>
