...
class Auth extends Controller
{
    ...
    */
    ...
    /*
        ...
        Permite:
            ...
            - En caso de validación. Inicia sesión y redirecciona al main de alumno
    ...
    */
    public function validate_login()
    {
        ...
        if (empty($password)) {
            $error['password'] = 'La contraseña es obligatorio';
        ...
        $_SESSION['mensaje'] = " Usuario ". $user->name . 'ha iniciado sesión con éxito';

        // redireccion al main de alumno
