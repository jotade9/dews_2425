            ...
            <div class="card-body">
                ...
                <input type="hidden" name="csrf_token"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select 
                            <?= (isset($this->error['editorial']))? 'is-invalid': null ?>" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control
                            <?= (isset($this->error['unidades']))? 'is-invalid': null ?>" 
                            id="unidades" name="unidades"
                            placeholder="Introduzca unidades" value="<?= htmlspecialchars($this->libro->unidades) ?>"
                            step="1" >
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
