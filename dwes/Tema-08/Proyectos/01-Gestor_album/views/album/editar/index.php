                ...
                <form action="<?= URL ?>album/update/<?= $this->id ?>/<?= $this->csrf_token?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            ...
                            name="descripcion" placeholder="Introduzca descripcion"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            ...
                            value="<?= htmlspecialchars($this->album->etiquetas) ?>" required>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control
                            <?= (isset($this->error['carpeta'])) ? 'is-invalid' : null ?>" id="carpeta"
                            name="carpeta" placeholder="Introduzca Carpeta"
                            value="<?= htmlspecialchars($this->album->carpeta) ?>" required>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
