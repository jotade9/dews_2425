            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/2/<?= $_SESSION['csrf_token']?>">titulo</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/3/<?= $_SESSION['csrf_token']?>">Lugar</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/4/<?= $_SESSION['csrf_token']?>">Categorias</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/5/<?= $_SESSION['csrf_token']?>">Etiquetas</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/6/<?= $_SESSION['csrf_token']?>">Nº Fotos</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/7/<?= $_SESSION['csrf_token']?>">Nº Visitas</a></li>
