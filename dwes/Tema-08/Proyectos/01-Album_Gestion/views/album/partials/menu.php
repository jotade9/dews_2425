<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?= URL ?>album">Álbumes</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link 
                    <?= in_array($_SESSION['id_rol'], $GLOBALS['album']['new']) ? 'active' : 'disabled' ?>" href="<?= URL ?>album/new">Nuevo</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle
                    <?= in_array($_SESSION['id_rol'], $GLOBALS['album']['order']) ? 'active' : 'disabled' ?>" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Ordenar
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?= URL ?>album/order/8">Num Fotos</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/order/9">Num Visitas</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/order/10">Carpeta</a></li>
                    </ul>
                </li>
            </ul>
            <form class="d-flex" role="search" method="GET" action="<?= URL ?>album/filter">
                ...
                <?= in_array($_SESSION['id_rol'], $GLOBALS['album']['filter']) ? null : 'disabled' ?>" type="submit">Buscar</button>
            </form>
        </div>
    </div>
</nav>