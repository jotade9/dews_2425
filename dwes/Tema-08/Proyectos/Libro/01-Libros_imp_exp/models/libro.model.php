...
class libroModel extends Model
{
    ...
    */
    ...
    /**
     * Método: import
     * descripción: importa un fichero csv con los datos de los libros, nombre de autores, editoriales y géneros
     * 
     * @param:
    ...
    public function import($libros)
    {
        try {
            ...
            foreach ($libros as $libro) {
                ...
                $stmt->bindParam(':generos_id', $libro[7], PDO::PARAM_STR);
...
id del libro*/
    ...
    */
    public function validateForeignKeyAutor( $autor_id)
    {
    ...
    */
    ...
    /*
        ...
        descripción: valida el id de un libro. Que exista en la base de datos
    ...
    */
    ...
    public function validateIdLibro($id)
    {
