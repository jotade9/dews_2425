    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table">
                    ...
                    <?php foreach ($array_articulos as $articulo): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="eliminar.php?id=<?= $articulo->getId() ?>" title="Eliminar" class="btn btn-danger" onclick="return confirm('Confirmar eliminación del articulo')"><i class="bi bi-trash-fill" ></i></a>
                ...
                <tfoot>
                    <tr>
                        <td colspan="6">Nº Registros <?= count($array_articulos) ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
