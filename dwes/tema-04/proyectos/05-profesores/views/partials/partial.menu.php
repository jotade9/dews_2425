            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="order.php?criterio=nrp">NRP</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=fecha_nacimiento">Edad</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=poblacion">Población</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=especialidad">Especialidad</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=asignaturas">Asignaturas</a></li>
                    </ul>
                </li>
