            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="order.php?criterio=titulo">Titulo</a></li>
                        ...
                        <li><a class="dropdown-item" href="order.php?criterio=fecha_edicion">Edición</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=materia">Materia</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=etiquetas">Etiquetas</a></li>
