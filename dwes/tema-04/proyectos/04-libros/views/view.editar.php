...
<body>
    ...
    <div class="container">
        ...
        <form action="update.php?indice=<?= $indice ?>" method="POST">
            ...
            <!-- autor -->
            <div class="mb-3">
                <label for="rauto" class="form-label">autor</label>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="fecha_edicion" value="<?= $libro->fecha_edicion ?>">
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="materia" id="materia">
                    ...
                    <?php foreach ($materias as $indice => $data): ?>
                        <option value="<?= $indice ?>" <?= ($libro->materias == $indice) ? 'selected' : null ?>>
                            <?= $data ?>
                        </option>
                    <?php endforeach; ?>
                </select>
                    ...
                    <?php foreach ($etiquetas as $indice => $data): ?>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="etiquetas[]" value="<?= $indice ?>"
                                <?= (in_array($indice, $libro->etiquetas) ? 'checked' : true) ?>>
