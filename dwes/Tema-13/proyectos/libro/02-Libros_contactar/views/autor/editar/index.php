...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- Formulario de autors  -->
                <form action="<?= URL ?>autor/update/<?= $this->id ?>/<?= $this->csrf_token?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <?= (isset($this->error['fecha_nac'])) ? 'is-invalid' : null ?>" id="fecha_nac" name="fecha_nac"
                            value="<?= htmlspecialchars($this->autor->fecha_nac ?? '') ?>" required>
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control
                        <?= (isset($this->error['fecha_def'])) ? 'is-invalid' : null ?>" id="fecha_def" name="fecha_def"
