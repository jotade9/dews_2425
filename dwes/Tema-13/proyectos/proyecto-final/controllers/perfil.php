...
require_once 'controllers/Contactar.php';
...
class Perfil extends Controller
{
    ...
    */
    public function update()
    {
        ...
        $contactar->enviarEmailModificacionPerfil($name, $email);
    ...
    */
    public function update_pass()
    {
        ...
        $this->model->updatePass($new_password, $_SESSION['user_id']);
         ...
         // enviar email de confirmación
         $contactar = new Contactar();
         $contactar->enviarEmailCambioPassword($user->name, $user->email);
    ...
    */
    public function delete($param = [])
    {
        ...
        $contactar = new Contactar();
        $contactar->enviarEmailEliminacionPerfil($user->name, $user->email);
