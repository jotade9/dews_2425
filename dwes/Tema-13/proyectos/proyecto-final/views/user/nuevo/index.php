                ...
                <form action="<?= URL ?>user/create" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select 
                            ...
                            <?php foreach ($this->roles as $indice => $data): ?>
                                <option value="<?= $indice ?>" selected> <!-- Por defecto se escogerá el rol Registrado -->
                                    <?= $data ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control <?= (isset($this->error['password_confirm'])) ? 'is-invalid' : null ?>"
                            id="password_confirm" name="password_confirm" placeholder="Introduzca contraseña" required>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
