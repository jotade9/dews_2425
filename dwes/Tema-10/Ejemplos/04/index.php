...
try {
    ...
    <img src="cid:oficina" alt="Oficina">
    ';
    ...
    $mail->addAttachment('files/Tema_10.pdf');

    // Adjuntar imagen
    $mail->addAttachment('files/oficina.jpg');

    // Adjuntar imagen
    $mail->addEmbeddedImage('files/oficina.jpg', 'oficina');
