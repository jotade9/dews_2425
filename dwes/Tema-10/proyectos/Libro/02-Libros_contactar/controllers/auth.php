...
class Auth extends Controller
{
    ...
    */
    public function validate_register()
    {
        ...
        $cuerpo_mensaje .= "Mensaje: Usuario registrado correctamente en la web Geslibros.\n";

        $this->enviarEmail($name, $email, 'Registro de usuario en la web Geslibros', $cuerpo_mensaje);

        // Genero mensaje de éxito
        $_SESSION['mensaje'] = 'Usuario registrado con éxito';

        // Compruebo si se ha mandado el email de confirmacion
    ...
    */
    function enviarEmail($name, $email, $subject, $message)
    {
        ...
        try {
            ...
            $_SESSION["mensaje_error"] = "El Mensaje no ha podido ser enviado. Mailer Error: {$mail->ErrorInfo}";
