...
class Auth extends Controller
{
    ...
    */
    public function validate_register()
    {
        ...
        // Envío un email de confirmación
        $subject = 'Registro de usuario en Geslibros';
        $message = "Nombre:  $name\n";
        $message .= "Email:  $email\n";
        $message .= "Mensaje: Hola $name, gracias por registrarte en nuestra plataforma";

        $this->enviarEmail($name, $email, $subject, $message);
