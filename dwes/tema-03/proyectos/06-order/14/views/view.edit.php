    ...
    <div class="container">
        ...
        <form action="update.php?:id=<?= $id?>" method="POST">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputid" name="id" value="<?=$registro['id'];?>" readonly>
                </div>
            </div>
            <!-- nombre -->
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="curso" class="form-control" id="inputcurso" name="curso" value="<?=$registro['curso'];?>">
                </div>
            </div>
            ...
            <button type="submit" formaction="create.php" class="btn btn-primary">Actualizar</button>
