    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <!-- Para cargar una url necesito llamar a la carpeta alumno y luego a la carpeta nuevo. con esto carga el index de esa carpeta -->
                    <a class="nav-link active" aria-current="page" href="alumno/nuevo">Nuevo</a>
                </li>
